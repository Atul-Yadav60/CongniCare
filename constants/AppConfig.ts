...
export const MODULES = {
  skinAI: {
    ...
    icon: 'camera',
    color: '#2EE6D6',
    features: ['Skin condition detection', 'Severity assessment', 'Self-care guidance'],
  },
  trustMed: {
    id: 'trustMed',
    name: 'TrustMed.AI',
    ...
    color: '#8A6CFF',
    features: ['Prescription verification', 'Medicine authenticity', 'Drug interactions'],
  },
  healMind: {
    id: 'healMind',
    name: 'HealMind.AI',
  ...
  pulseNet: {
    ...
    icon: 'location',
    color: '#3B82F6',
    features: ['Local health alerts', 'Disease outbreaks', 'Environmental factors'],
  },
  symptoCare: {
    id: 'symptoCare',
    name: 'SymptoCare.AI',
    ...
    icon: 'medical',
    color: '#10B981',
    features: ['Symptom analysis', 'Specialist recommendation', 'Urgency assessment'],
  },
  medPlanner: {
    id: 'medPlanner',
    name: 'MedPlanner',
    ...
    icon: 'calendar',
    color: '#F59E0B',
    features: ['Medication scheduling', 'Reminder system', 'Adherence tracking'],
  },
};
...
export const REGIONS = [
  ...
  { code: 'IN-KA', name: 'Karnataka', cities: ['Bangalore', 'Mysore', 'Hubli'] },
];
